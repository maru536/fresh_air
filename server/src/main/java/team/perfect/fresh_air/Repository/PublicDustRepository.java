...
public interface PublicDustRepository extends CrudRepository<PublicDust, AddressPK> {
    @Modifying
    @Transactional
    @Query(value="INSERT public_dust(address_level_one, address_level_two, date_time, pm100) VALUES (:address_level_one, '', :date_time, :pm100) ON DUPLICATE KEY UPDATE date_time = :date_time, pm100 = :pm100", nativeQuery=true)
    ...
    @Modifying
    @Transactional
    @Query(value="INSERT public_dust(address_level_one, address_level_two, date_time, pm25) VALUES (:address_level_one, '', :date_time, :pm25) ON DUPLICATE KEY UPDATE date_time = :date_time, pm25 = :pm25", nativeQuery=true)
    Integer upsertPM25(@Param("address_level_one") String address_level_one, @Param("date_time") String date_time, @Param("pm25") int pm25);

    @Modifying
    @Transactional
    @Query(value="INSERT public_dust(address_level_one, address_level_two, date_time, pm100, pm25) VALUES (:address_level_one, :address_level_two, :date_time, :pm100, :pm25) ON DUPLICATE KEY UPDATE date_time = :date_time, pm100 = :pm100, pm25 = :pm25", nativeQuery=true)
